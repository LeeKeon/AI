...
class movie_data(object):
    ...
    def __init__(self, read_type='both', max_vocab=30000, max_len=500, end_token="<eos>", data_type="both"):
        ...
        self.train_size = int(len(files) * 0.9)
        ...
        if(self.data_type == "both"):
            ...
            #self.x_ids_train, self.x_len_train = self.init_data_test(train_files)
            ...
            self.x_ids_train, self.x_len_train, self.y_train = self.init_data(train_files)
            self.x_ids_test, self.x_len_test, self.y_test = self.init_data(test_files)
    ...
    def get_train(self, batch_size=20):
        ...
        return self.x_ids_train[pt: pt+batch_size], self.x_len_train[pt: pt+batch_size], self.y_train[pt: pt+batch_size]

    def get_test(self, batch_size=20):
        pt = self.test_pt
        self.test_pt = (self.test_pt + batch_size) % self.test_size
        return self.x_ids_test[pt: pt+batch_size], self.x_len_test[pt: pt+batch_size],self.y_test[pt: pt+batch_size]
