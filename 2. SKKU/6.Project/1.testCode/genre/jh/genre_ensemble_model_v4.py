...
#         print('x_image',x_image)
        ...
        # istate_fw = tf.contrib.layers.fully_connected(img_vector, self.hidden_dim*2, activation_fn=tf.nn.relu,weights_regularizer=tf.contrib.layers.l2_regularizer(scale=0.2))
...
#         text_vec = tf.concat([fw_state.h, bw_state.h], 1)
        ...
        # out = tf.concat([fc_l1, lstm_out], axis=1)
        final_layer = tf.add(fc_l1, lstm_out)
    ...
    def save(self, sess, global_step=None):
        ...
        save_path = saver.save(sess, save_path="models/model4", global_step=global_step)
